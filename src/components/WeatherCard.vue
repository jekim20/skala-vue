...
<template>
  <!-- ========================================
       수정 코드: 카드 전체 클릭 및 Enter/Space 키로 지도 위치 선택
       ======================================== -->
  <div
    class="weather-card"
    ...
    role="button"
    tabindex="0"
    :aria-label="`${cityItem.name} 위치를 지도에 표시`"
